...
for epoch = 1:epochs
  ...
  for m = 1:numbatches
    ...
    embed_to_hid_weights_gradient =  embedding_layer_state * back_propagated_deriv_1'; #DONE(?)
    % Options:
    % (a) embed_to_hid_weights_gradient = back_propagated_deriv_1' * embedding_layer_state; #WRONG
    ...
    % FILL IN CODE. Replace the line below by one of the options. #DONE(?)
    ...
    % (c) back_propagated_deriv_2 = back_propagated_deriv_1' * embed_to_hid_weights; #WRONG
